  ...
  return (
    ...
    >
      ...
      <Typography variant="caption" color={'text.secondary'} mt={1}>
        Get them fusing keycards or Buy them
      </Typography>
      <Box sx={{ display: 'flex', gap: 2, mt: 2 }}>
        <Button
          ...
          to={{
            pathname: '/gameloop/gamification/keycards',
          }}
          component={NextLinkComposed}
        >
          <Typography variant="lbl-md">Go to Keycards</Typography>
        </Button>
        <Button
          variant="contained"
          fullWidth
